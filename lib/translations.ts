...
const en = {
  ...
  brandHub: {
    ...
    sponsorCodeLabel: "Code",
    sponsors: [
      { name: "TEVEO", subtitle: "Premium activewear, built for serious lifters.", code: "ARTUR10", href: "https://www.teveo.com/" },
      { name: "Peptide Revolution", subtitle: "Research peptides — maximum discount with code.", code: "BAUSTELLE", href: "https://peptiderevolution.eu/" },
    ],
...
const de: typeof en = {
  ...
  brandHub: {
    ...
    sponsorCodeLabel: "Code",
    sponsors: [
      { name: "TEVEO", subtitle: "Premium Sportbekleidung, gebaut für ernsthafte Athleten.", code: "ARTUR10", href: "https://www.teveo.com/" },
      { name: "Peptide Revolution", subtitle: "Forschungspeptide — maximaler Rabatt mit dem Code.", code: "BAUSTELLE", href: "https://peptiderevolution.eu/" },
    ],
...
const sq: typeof en = {
  ...
  brandHub: {
    ...
    sponsorsLabel: "Sponsorë",
    sponsorLabel: "Sponsor",
    sponsorCodeLabel: "Kodi",
    sponsors: [
      { name: "TEVEO", subtitle: "Veshje sportive premium, e ndërtuar për atletë seriozë.", code: "ARTUR10", href: "https://www.teveo.com/" },
      { name: "Peptide Revolution", subtitle: "Peptide kërkimi — zbritje maksimale me kodin.", code: "BAUSTELLE", href: "https://peptiderevolution.eu/" },
    ],
