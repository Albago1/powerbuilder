...
const en = {
  ...
  brandHub: {
    ...
    featuredBadge: "Featured Offer",
    featuredTitle: "4 Week Personalized Program",
    featuredSubtitle: "Training & Nutrition System",
    featuredPrice: "€99",
    featuredCta: "Build My Program →",
  },
  ...
  benchPress: {
    ...
    pillars: [
      { title: "Bench Strength", description: "Heavy work in the 1–5 rep range on main bench variations. Every session pushes the top-end strength ceiling higher." },
      { title: "Chest Power", description: "Hypertrophy-range pressing (6–12 reps) using incline, cable, and dumbbell variations builds the chest thickness that transfers to the bar." },
      { title: "Pressing Mechanics", description: "Technique cues, paused reps, and touch-and-go variations refine your form under load — the fastest way to add sustainable weight." },
    ],
    faqs: [
      ...
      { question: "Will this program add chest size or just strength?", answer: "Both. The program combines heavy strength work (1–5 rep range) on the main bench variations with hypertrophy-focused accessory pressing (6–12 reps). You'll build the chest thickness and pressing strength at the same time." },
      { question: "What equipment do I need?", answer: "A barbell, bench press station, and access to cables or dumbbells for accessory work. A full commercial gym is ideal. You cannot run this program effectively with dumbbells only — the main movements require a barbell." },
      { question: "How much weight will I add to my bench in 6 weeks?", answer: "Results depend on your starting point, consistency, and nutrition. Most lifters see 5–15kg added to their working max over 6 weeks when following the program correctly. The program is structured to push your ceiling each week — what you get out of it reflects what you put in." },
    ],
  },
...
const de: typeof en = {
  ...
  brandHub: {
    ...
    featuredBadge: "Hauptangebot",
    featuredTitle: "4-Wochen Personalisiertes Programm",
    featuredSubtitle: "Training- & Ernährungssystem",
    featuredPrice: "€99",
    featuredCta: "Mein Programm erstellen →",
  },
  personalized: {
    meta: {
  ...
  benchPress: {
    ...
    pillars: [
      { title: "Bankdrück-Kraft", description: "Schweres Training im 1–5 Wdh.-Bereich auf den wichtigsten Bankdrück-Variationen. Jede Einheit schiebt die Kraftgrenze höher." },
      { title: "Brust-Power", description: "Hypertrophie-Bankdrücken (6–12 Wdh.) mit Schrägbankdrücken, Kabel- und Kurzhantelvariationen baut die Brustdicke auf, die sich auf die Stange überträgt." },
      { title: "Drück-Mechanik", description: "Technik-Cues, Pause-Reps und Touch-and-Go-Variationen verfeinern deine Form unter Last — der schnellste Weg, nachhaltiges Gewicht hinzuzufügen." },
    ],
    faqs: [
      ...
      { question: "Bringt dieses Programm Brustgröße oder nur Kraft?", answer: "Beides. Das Programm kombiniert schweres Krafttraining (1–5 Wdh.) auf den wichtigsten Bankdrück-Variationen mit hypertrophiefokussiertem Zusatzdrücken (6–12 Wdh.). Du baust Brustdicke und Drückkraft gleichzeitig auf." },
      { question: "Welche Ausrüstung benötige ich?", answer: "Eine Langhantel, Bankdrück-Station und Zugang zu Kabeln oder Kurzhanteln für Zusatzübungen. Ein vollständiges Fitnessstudio ist ideal. Du kannst dieses Programm nicht effektiv nur mit Kurzhanteln ausführen — die Hauptbewegungen erfordern eine Langhantel." },
      { question: "Wie viel Gewicht werde ich in 6 Wochen beim Bankdrücken aufbauen?", answer: "Die Ergebnisse hängen von deinem Ausgangspunkt, Konsistenz und Ernährung ab. Die meisten Kraftsportler sehen 5–15 kg, die in 6 Wochen zu ihrem Arbeitsmaximum hinzugefügt werden, wenn sie das Programm korrekt befolgen." },
    ],
  },
  strictCurl: {
...
const sq: typeof en = {
  ...
  brandHub: {
    ...
    featuredBadge: "Oferta e Veçantë",
    featuredTitle: "Program Personal 4 Javë",
    featuredSubtitle: "Sistemi i Stërvitjes & Ushqimit",
    featuredPrice: "€99",
    featuredCta: "Krijo Programin Tim →",
  },
  personalized: {
    meta: {
  ...
  benchPress: {
    ...
    pillars: [
      { title: "Forcë Bench Press", description: "Punë e rëndë në rangun 1–5 përsëritje mbi variacionet kryesore bench press. Çdo seancë e shtyn tavanin e forcës më lart." },
      { title: "Fuqi Gjoksi", description: "Shtytje në rang hipertrofie (6–12 përsëritje) duke përdorur variacionet incline, kabllo dhe gjevrek ndërtojnë trashësinë e gjoksit që transferohet në shtangë." },
      { title: "Mekanika e Shtytjes", description: "Sugjerime teknike, pause rep dhe variacionet touch-and-go rafinojnë formën tënde nën ngarkesë — mënyra më e shpejtë për të shtuar peshë të qëndrueshme." },
    ],
    faqs: [
      ...
      { question: "A do të shtojë ky program madhësinë e gjoksit apo vetëm forcën?", answer: "Të dyja. Programi kombinon punë të rëndë force (rang 1–5 pérsëritje) mbi variacionet kryesore bench press me shtytje ndihmëse të fokusuar në hipertrofi (6–12 pérsëritje). Do të ndërtosh trashësinë e gjoksit dhe forcën e shtytjes njëkohësisht." },
      { question: "Çfarë pajisje më duhen?", answer: "Një shtangë e gjatë, stacion bench press dhe qasje në kabllo ose gjevrekë për punë ndihmëse. Një palestër komerciale e plotë është ideale. Nuk mund ta drejtosh këtë program efektivisht vetëm me gjevrekë — lëvizjet kryesore kërkojnë shtangë të gjatë." },
      { question: "Sa peshë do të shtoj në bench press në 6 javë?", answer: "Rezultatet varen nga pika juaj fillestare, konsistenca dhe ushqyerja. Shumica e ngritësve shohin 5–15 kg të shtuar maksimumit të tyre të punës gjatë 6 javëve kur ndjekin programin saktë." },
    ],
  },
  strictCurl: {
