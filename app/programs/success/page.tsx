...
export const metadata: Metadata = {
  ...
  description: "Your purchase was successful. Your program PDF will be delivered to your email shortly.",
};
    ...
    <div className="bg-brand-bg min-h-screen pt-16">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
            ...
            {[
              {
                ...
                description: "Check your email for a PayPal payment confirmation. This is your purchase receipt.",
              },
              {
                num: "02",
                title: "PDF Delivery",
                description: "Your program PDF will be sent to your PayPal email address within a few hours.",
              },
              {
                num: "03",
                title: "Start Training",
                description: "Open your PDF, read the introduction, and start on Day 1. The progressive overload is built in — just follow the plan.",
              },
            ].map((step, i) => (
        ...
        <div className="text-center border-t border-brand-border pt-10">
          ...
          <a
            href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL ?? "contact@powerbuilder.com"}?subject=${encodeURIComponent("PDF Not Received")}`}
