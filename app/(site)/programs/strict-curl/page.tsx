    ...
    <div className="bg-brand-bg pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-brand-card border border-brand-border p-8 md:p-10">
              ...
              <StaticProgramBuyButton slug="strict-curl" price={program.price} className="mb-4" />
      ...
      <section className="py-24 md:py-32">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <StaticProgramBuyButton slug="strict-curl" price={program.price} className="max-w-xs mx-auto" />
